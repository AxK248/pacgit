...
curl -sL "https://raw.githubusercontent.com/AxK248/pacgit/windows/pacgit.bat" -o "%ProgramData%\github-packages\pacgit\pacgit.bat" >nul
echo pacgit command promt — Done.
:: information
curl -sL "https://raw.githubusercontent.com/AxK248/pacgit/main/info.txt" -o "%ProgramData%\github-packages\pacgit\info.txt" >nul
:: Uninstall command
curl -sL "https://raw.githubusercontent.com/AxK248/pacgit/windows/uninstall.bat" -o "%ProgramData%\github-packages\pacgit\uninstall.bat" >nul
echo Creating uninstalling batch — Done.
:: Shortcut for cmd
curl -sL "https://raw.githubusercontent.com/AxK248/pacgit/windows/pacgit.lnk" -o "%windir%\pacgit.bat" >nul
